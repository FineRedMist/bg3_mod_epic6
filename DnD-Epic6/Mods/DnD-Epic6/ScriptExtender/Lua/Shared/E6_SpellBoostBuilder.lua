...
function MakeBoost_UnlockSpell(spell, makeMultiuseSpells)
    ...
    if makeMultiuseSpells then
        base = base .. ";IF(HasActionResource('SpellSlot'," .. tostring(spell.Level) .. ",1,false,false,context.Source)):" .. MakeUnlockSpellBoost(spell.SpellId, "AddChildren", "d136c5d9-0ff0-43da-acce-a74a07f8d6bf", nil, spell.Ability)
        base = base .. ";IF(HasActionResource('WarlockSpellSlot'," .. tostring(spell.Level) .. ",1,false,false,context.Source)):" .. MakeUnlockSpellBoost(spell.SpellId, "MostPowerful", "e9127b70-22b7-42a1-b172-d02f828f260a", nil, spell.Ability)
    end
    return base
end
